...
---@field on fun(self: Game, name: '卡牌-询问', callback: fun(askCard: AskCard): any): function
---@field fire fun(self: Game, name: '卡牌-询问', askCard: AskCard): any
---@field on fun(self: Game, name: '卡牌-答复', callback: fun(askCard: AskCard): any): function
---@field fire fun(self: Game, name: '卡牌-答复', askCard: AskCard): any
---@field on fun(self: Game, name: '卡牌-答复后', callback: fun(askCard: AskCard): any): function
---@field fire fun(self: Game, name: '卡牌-答复后', askCard: AskCard): any
